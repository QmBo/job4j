...
public class ControlQualityTest {
    ...
    public void whenFirstAddThenSort() {
        ...
        RControlQuality controlQuality = new RControlQuality(new ControlQuality(this.now, warehouse), rework);
        List<Food> resW = controlQuality.checkQuality();
        controlQuality = new RControlQuality(new ControlQuality(this.now, shop), rework);
        List<Food> resS = controlQuality.checkQuality(resW);
        controlQuality = new RControlQuality(new ControlQuality(this.now, trash), rework);
        List<Food> resT = controlQuality.checkQuality(resS);
        controlQuality = new RControlQuality(new ControlQuality(this.now, rework), rework);
        ...
        controlQuality = new RControlQuality(new ControlQuality(this.now, warehouse), rework);
